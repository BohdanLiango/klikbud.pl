                    ...
                    <div id="rev_slider_1077_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                        <ul>
                            ...
                            @foreach($sliders as $slider)
                                <li data-index="rs-{{ $slider->slider_number_show }}00" data-transition="slideoverhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="{{ asset(Storage::disk('s3')->url($slider->image->path)) }}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Big &amp; Bold" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    {{--<!-- MAIN IMAGE -->--}}
                                    <img src="{{ Storage::disk('s3')->url($slider->image->path) }}"  alt="{{ $slider->alt[App::getLocale()] }}"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                                    {{--<!-- LAYERS -->--}}
                                    {{--<!-- LAYER NR. 1 -->--}}
                                    ...
                                    <div class="tp-caption BigBold-Title   tp-resizeme"
                                         ...
                                         style="z-index: 6;
                                            ...
                                            color:#fff;
                                            "><span class="text-primary"> {{ $slider->textYellow[App::getLocale()]}} </span> {{ $slider->textBlack[App::getLocale()] }} </div>
                                    {{--<!-- LAYER NR. 4 -->--}}
                                    ...
                                    <div class="tp-caption BigBold-Button rev-btn "
                                         ...
                                         style="z-index: 8; ">
                                        <a data-href="#welcome-page" class="site-button outline white">{{ __('main.slide.button') }}</a>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
