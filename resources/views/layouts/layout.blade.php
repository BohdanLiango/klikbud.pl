...
<head>
    ...
    @livewireStyles
    @yield('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style.min.css') }}"> {{--style1.css to work--}}
    {{--<!-- GOOGLE FONTS -->--}}
    <link
        href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,300italic,400italic,500,500italic,700,700italic,900italic,900'
