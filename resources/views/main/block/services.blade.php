            ...
            <div class="owl-carousel Home-services-carousel owl-btn-vertical-center">
                ...
                <div class="item">
                    <div class="wt-box bg-white">
                        <div class="wt-media">
                            <a href="javascript:void(0);"><img src="{{ Storage::url($service->file->path) }}" alt="{{ $service->alt }}" style="width: 360px; height: 225px"></a>
                        </div>
                        <div class="wt-info p-tb30">
                            <h4 class="wt-title m-t0 m-b5"><a href="javascript:void(0);">{{ $service->title }}</a></h4>
